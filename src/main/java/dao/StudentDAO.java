...
public class StudentDAO {
    // 获取全部表字段
    public void getOneRow(List<Map<String, Object>> list, ResultSet rs) throws SQLException {
    ...
    public List<Map<String, Object>> getStudents(Student stu) {
        ...
        List<String> updates = new ArrayList<>(); // sql 更新
        List<Object> params = new ArrayList<>(); // 字段值填充
        ...
        try (Connection conn = DBUtil.getConnection()) {
            ...
            StringBuilder sql = new StringBuilder("SELECT * FROM stu_info WHERE 1=1 AND ");
